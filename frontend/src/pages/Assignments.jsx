...
// ── Assignment row ────────────────────────────────────────────────────────────
function AssignmentRow({ assignment, onEdit, onDelete, onToggle, onView, index }) {
    ...
    >
      <div className="flex items-center gap-3 px-4 py-3.5">
        <motion.button onClick={() => onToggle(assignment)}
          ...
          style={{ background: isComplete ? '#10b981' : 'transparent', borderColor: isComplete ? '#10b981' : 'rgba(255,255,255,0.2)' }}
  ...
  return (
    <div className="space-y-5 max-w-4xl">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <motion.button onClick={() => setSyllabusOpen(true)}
            ...
            <DocumentTextIcon className="w-4 h-4" /> Import Syllabus
          </motion.button>
